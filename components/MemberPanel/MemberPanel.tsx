  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        <button onClick={onEdit} className="text-xs text-gray-400 hover:text-indigo-500 px-1" title="編集">
          ✎
        </button>
        <button onClick={onRemove} className="text-xs text-gray-400 hover:text-red-500 px-1" title="削除">
          🗑
        </button>
      </div>
